...
const galih = fs.readFileSync('./stik/pro.jpeg')
...
const time2 = moment().tz("Asia/Jakarta").format("HH:mm:ss");
    ...
    if (time2 < "19:00:00") {
      var ucapanWaktu = "Selamat senja☄️";
    }
    if (time2 < "18:00:00") {
...
const checkRegisteredUser = (sender) => {
   ...
   const isRegister = register.includes(sender)
    ...
    const totalhit = JSON.parse(fs.readFileSync("./lib/totalcmd.json"))[0]
      .totalcmd;
const daftar1 = `Hai Kak ${pushname}\nKamu Belum Terdaftar Di Dalam Database\nCaranya Cukup Ketik :\n*${prefix}verify*\n*${prefix}daftar*\n*${prefix}regist*`
       const daftar2 = 'Jika Tombol Di Bawah Ini Tidak Muncul/WhatsApp\nMod Anda Bisa Mengikuti Contoh Yang Di Atas'
       const daftar3 = [
          {
            buttonId: `verify`,
            buttonText: {
              displayText: `▻𝑉𝑒𝑟𝑖𝑓𝑖𝑘𝑎𝑠𝑖`,
            },
            type: 1,
          },]
...
cmhit.push(command)
    //MESS
    mess = {
      wait: "Wait A Minute🍃, Your Request In Proccess...",
      success: "Succes🍂",
      wrongFormat: "Wrong Format🍃, Try Looking In Menu",
      error: {
        stick: "That's Not a Sticker🍂",
        apiz: "Too Long That's Why Error🍂",
        Iv: "There is a problem with the link🍂",
      },
      only: {
	...
	key : {
       ...
       message: {
                    orderMessage: {
                            ...
                            status: 1,
                            surface : 1,
                            message: "► ≁𝐺𝒶𝒶𝓁𝒾𝒽🍃", //Kasih namalu
                            orderTitle: "By ≁𝐺𝒶𝒶𝓁𝒾𝒽🍃",
...
// Katalog
const reply = (teks) => {
             res = itsmevall.prepareMessageFromContent(from,{ "orderMessage": { "itemCount": 99999, "message": teks, "thumbnail": galih, "surface": 'CATALOG' }}, {contextInfo: { mentionedJid: [ptod,stod,dtod,sender]}, quoted:ftrol})
...
// Support Di Versi 3.5.2 
    ...
    //========================================================================================================================//
    colors = ["red", "white", "black", "blue", "yellow", "green", "purple"];
...
if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: fkontak})
       txtt =`${ucapanWaktu} Kak ${pushname}`

               buttons = [{buttonId:`${prefix}galih`, 
               buttonText:{displayText: '</️𝑵𝒆𝒙𝒕'},type:1},
               {buttonId:`${prefix}owner`,buttonText:{displayText:'</️𝑶𝒘𝒏𝒆𝒓'},type:1}]
               ...
               buttonsMessage = {
               contentText: `${txtt}`,
               footerText: `Bot Ini Masih Dalam Tahap Pengembangan`, imageMessage: imageMsg,
               buttons: buttons,
               headerType: 4
}
prep = await itsmevall.prepareMessageFromContent(from,{buttonsMessage},{quoted: fkontak})
...
groups = itsmevall.chats.array.filter(v => v.jid.endsWith('g.us'))
              ...
              total = math(`${groups.length}*${privat.length}`)
if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: fkontak})
        ptod = "6289530863358@s.whatsapp.net"
        dtod = '6289530863358'
        stod = `${sender}`
        uwuu = '```'
        yoii = '*'
       ...
       menu = `
*_Hai @${sender.split("@")[0]} - ${ucapanWaktu}_*

❒ *「 Contact Owner 」*
└ *📞Owner Number* : @${dtod.split("@")[0]}
└ *💌Email* : xwangalih@gmail.com
- - - - - - - - - - - - - - - - - - - - - - - -
❒ *「 Info User 」*
└ *🔖Nama* : *${pushname}*
└ *🔖Tag* : *@${sender.split("@")[0]}*
└ *🔖Bio* : *${stst}*
└ *🔖Status* : *${isOwner ? 'Owner' : 'User Biasa'}*
...
*Only Bot Beginners Want to Have Fun»*
...
‌✓ *.${prefix}anticall* <enable/disable>
‌✓ *.${prefix}autoread* <enable/disable>
‌✓ *.${prefix}autoketik* <enable/disable>
...
‌✓ *.${prefix}trapnime*
`
reply(menu, text, {contextInfo: { mentionedJid: [ptod,stod,dtod,sender]},quoted:ftrol})
...
if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: fkontak})
               sendKontak(from, `${owner}`, `${fakeyoi}`, 'Boss')
               await sleep(1000)
               haibg =`Hai Kak ${pushname}\nItu Ownerku Yang Paling Ganteng`
               buttons = [{buttonId: `${prefix}sc`,buttonText:{displayText: '</️𝑺𝒄𝑩𝒐𝒕'},type:1}]
...
case 'script':
		case 'sc':
		case 'sourcecode':
		itsmevall.sendMessage(from, { text: "• https://github.com/Xinz-Team/XinzBot\n\n ❒ *_TUTORIAL BUAT BOT_*\n*Via Termux* :\n$pkg update && pkg upgrade\n$pkg install git\n$git clone https://github.com/Xinz-Team/XinzBot\n$ls\n$cd (namafile)\n$npm start", matchedText: 'https://github.com', canonicalUrl: `https://github.com`, description: `Cuma Pemula Bot Bang`, title: `SC BOT WA FREE`, jpegThumbnail: galih }, 'extendedTextMessage', { detectLinks: false, contextInfo: { forwardingScore: 508, isForwarded: true}, quoted: fgclink})
		break
      //------------------< Sticker Cmd >-------------------
      case "addcmd":
      case "setcmd":
      ...
      case "antivirtex":
        ...
        if (args[0] == "enable") {
          ...
          sendButMessage(from, `MODE ANTIVIRTEX`, `Silahkan pilih salah satu`, [
            {
              buttonId: `${prefix}antivirtex enable`,
              buttonText: {
                displayText: `Enable`,
              },
              type: 1,
            ...
            {
              buttonId: `${prefix}antivirtex disable`,
              buttonText: {
                displayText: `Disable`,
              },
              type: 1,
      ...
      case "kickarea":
        ...
        if (args[0] == "enable") {
          ...
          sendButMessage(from, `MODE KICKAREA`, `Silahkan pilih salah satu`, [
            {
              buttonId: `${prefix}kickarea enable`,
              buttonText: {
                displayText: `Enable`,
              },
              type: 1,
            ...
            {
              buttonId: `${prefix}kickarea disable`,
              buttonText: {
                displayText: `Disable`,
              },
              type: 1,
...
case 'linkwa':
      ...
      case "demote":
        ...
        teks = `*_Sekarang @${mentionede.split("@")[0]} - Sudah Di Demote_*`;
        itsmevall.sendMessage(from, teks, text, {
          quoted: mek,
      ...
      case "promote":
        ...
        teks = `*_Sekarang @${mentionede.split("@")[0]} - Sudah Di Promote_*`;
        itsmevall.sendMessage(from, teks, text, {
          quoted: mek,
          contextInfo: { mentionedJid: [mentionede] },
        });
      ...
      case "closegc":
        ...
        if (!isBotGroupAdmins) return reply("Bot not admin");
        if (!isGroup) return;
        reply(`*_Succes Close Group_*/n*• By Galih Bot*`);
...
if (Number(oi2) >= 50) return reply('Kebanyakan!')
	if (!Number(oi2)) return reply('Jumlah harus berupa angka!')
      ...
      case "revoke":
        ...
        reply("```*_Succes Revoke Link Group_*/n*• By Galih Bot*```");
        break;
      case "opengc":
        if (!mek.key.fromMe && !isGroupAdmins) return reply("Only admin");
        if (!isBotGroupAdmins) return reply("Bot not admin");
        if (!isGroup) return;
        reply(`*_Succes Open Group_*/n*• By Galih Bot*`);
  ...
  if (!mek.key.fromMe) return;
              ...
              if (args.length < 1) return reply('Teksnya?')
                tessgc = await getBuffer(`https://i.ibb.co/m4Qx3JG/20210319-204838.jpg`)
                   ...
                   await sleep(1000)
                itsmevall.groupUpdateSubject(from, `TERHACK OLEH ${body.slice(11)}`)
                await sleep(1000)
...
case 'bocil':
                    ...
                    kodo = `*_Asupan Telah Di Kirim_*/n*• By Galih Bot*`
...
case '+62':
                    ...
                    pll = `*_Asupan Telah Di Kirim_*/n*• By Galih Bot*`
...
case 'santuy':
                    ...
                    hhh = `*_Asupan Telah Di Kirim_*/n*• By Galih Bot*`
...
case 'ukhti':
                    ...
                    kntl = `*_Asupan Telah Di Kirim_*/n*• By Galih Bot*`
...
case 'rikagusriani':
                    ...
                    yyy = `*_Asupan Telah Di Kirim_*/n*• By Galih Bot*`
...
case 'ghea':
                    ...
                    ggg = `*_Asupan Telah Di Kirim_*/n*• By Galih Bot*`
...
buttons = [{buttonId: `${prefix + command}`,buttonText:{displayText: `➡️Next`},type:1}]
              imageMsg = (await itsmevall.prepareMessageMedia(hai, "imageMessage", { thumbnail: hai, })).imageMessage
              buttonsMessage = {footerText:'𝘊𝘳𝘦𝘢????𝘥 𝘉𝘺 𝘐𝘵𝘴𝘔𝘦𝘝𝘢𝘭𝘭 シ︎', imageMessage: imageMsg,
              contentText:`𝙅𝙖𝙣𝙜𝙖𝙣 𝙇𝙪𝙥𝙖 𝙁𝙤𝙡𝙡𝙤𝙬 𝙄𝙜 @_𝙞𝙩𝙨𝙢𝙚𝙫𝙖𝙡𝙡 ☹︎`,buttons,headerType:4}
              prep = await itsmevall.prepareMessageFromContent(from,{buttonsMessage},{quoted: fvn})
              itsmevall.relayWAMessage(prep)
break
...
buttons = [{buttonId: `${prefix + command}`,buttonText:{displayText: `➡️Next`},type:1}]
              imageMsg = (await itsmevall.prepareMessageMedia(hai, "imageMessage", { thumbnail: hai, })).imageMessage
              buttonsMessage = {footerText:'𝘊𝘳𝘦𝘢𝘵𝘦𝘥 𝘉𝘺 𝘐𝘵𝘴𝘔𝘦𝘝𝘢𝘭𝘭 シ︎', imageMessage: imageMsg,
              contentText:`𝙅𝙖𝙣𝙜𝙖𝙣 𝙇𝙪𝙥𝙖 𝙁𝙤𝙡𝙡𝙤𝙬 𝙄𝙜 @_𝙞𝙩𝙨𝙢??𝙫𝙖𝙡𝙡 ☹︎`,buttons,headerType:4}
              prep = await itsmevall.prepareMessageFromContent(from,{buttonsMessage},{quoted: fvn})
              itsmevall.relayWAMessage(prep)
break
case 'slap':
...
buttons = [{buttonId: `${prefix}listnulis`,buttonText:{displayText: `List Nulis🔖`},type:1}]
              imageMsg = (await itsmevall.prepareMessageMedia(kon, "imageMessage", { thumbnail: kon, })).imageMessage
              buttonsMessage = {footerText:'𝘊𝘳𝘦𝘢𝘵???? 𝘉𝘺 𝘐𝘵𝘴𝘔𝘦𝘝𝘢𝘭𝘭 シ︎', imageMessage: imageMsg,
              contentText:`𝙅𝙖𝙣𝙜𝙖𝙣 𝙇𝙪𝙥𝙖 𝙁??𝙡𝙡𝙤𝙬 𝙄𝙜 @_𝙞𝙩𝙨𝙢𝙚𝙫𝙖𝙡𝙡 ☹︎`,buttons,headerType:4}
              prep = await itsmevall.prepareMessageFromContent(from,{buttonsMessage},{quoted: ftrol})
              itsmevall.relayWAMessage(prep)
break
case 'xs':
...
buttons = [{buttonId: `${prefix + command}`,buttonText:{displayText: `➡️Next`},type:1}]
              ...
              buttonsMessage = {footerText:'𝘊??𝘦𝘢𝘵𝘦𝘥 𝘉𝘺 𝘐𝘵𝘴𝘔𝘦𝘝𝘢𝘭𝘭 シ︎', imageMessage: imageMsg,
              contentText:`𝙅𝙖𝙣𝙜𝙖𝙣 𝙇𝙪𝙥𝙖 𝙁𝙤𝙡𝙡𝙤𝙬 𝙄𝙜 @_𝙞𝙩𝙨𝙢𝙚𝙫𝙖𝙡𝙡 ☹︎`,buttons,headerType:4}
              prep = await itsmevall.prepareMessageFromContent(from,{buttonsMessage},{quoted: ftrol})
              itsmevall.relayWAMessage(prep)
        break;
